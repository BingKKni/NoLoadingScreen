...
public interface PlayerAccessor {
	...
	/** Player.tick's copied main-hand snapshot; the equip animation restarts when it changes. */
	@Accessor("lastItemInMainHand") ItemStack nls$lastItemInMainHand();
	@Accessor("lastItemInMainHand") void nls$setLastItemInMainHand(ItemStack stack);
}
