...
public final class MixinVerification implements PreLaunchEntrypoint {
	...
	static void verifyTransformations() throws ReflectiveOperationException {
		Map<String, String[]> targets = Map.ofEntries(
			...
			Map.entry("net.minecraft.client.gui.components.CommandSuggestions", new String[]{"nls$localSuggestions", "nls$mergeClientSuggestions"}),
			Map.entry("net.minecraft.server.packs.resources.ReloadableResourceManager", new String[]{"nls$prepareAfterResources"}),
