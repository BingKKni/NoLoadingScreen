 ...
 * {@link #isShutdown()}. Allocated without construction: it owns no thread, level, socket or save,
 * and it ends by itself once the armed time has passed.
 */
public final class SaveWaitProbe extends IntegratedServer {
	private long deadline;

	private SaveWaitProbe() {
		super(null, null, null, null, null, null, null); // never invoked; the fixture allocates instances
	}
