...
public final class SceneFactory {
	...
	/** Fresh stats, recipe book and totem-activation state: nothing of the real session is shared. */
	public static LocalPlayer createPlayer(final MultiPlayerGameMode gameMode, final ClientLevel level) {
		return gameMode.createPlayer(level, new StatsCounter(), new ClientRecipeBook(), new ItemActivation());
	}
